...
=======
      ...
      <ScrollView style = {styles.container}>
          <View style = {styles.viewpontos}>
              <TouchableOpacity
                style = {{ width: '5%', marginRight: 45,marginTop: -7, justifyContent: 'center'}}
                onPress = { () => {Alert.alert( ' A soma de todos os atributos deve ser no máximo 60 pontos!\n Valor máximo do atributo: 15\n Valor mínimo do atributo: 5 ' )} }
              >
                  <Image
              ...
              <Text style = {{ marginLeft: 130,color: 'gold', fontWeight: 'bold', fontSize: 32,}} > Atributos </Text>
          ...
          < View style = {styles.setAtributos}  >
                ...
                <Text style = {styles.textoAtributos} > Pontos: { pontos } </Text>
